...
\begin{advancedtask} Download a list of names from \url{https://angrypenguin.000webhostapp.com/sample_data3.txt}. Sort these names into alphabetical order. Give each name a score by summing the values of the letters where A = 1, B = 2... Z = 26. Multiply the score of the name by the position of the name in the list. What is the total sum of all of the name scores?\end{advancedtask}
